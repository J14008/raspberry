<div class="sensors index">
	...
	<tr>
		<td><?php echo h($sensors['sensor']['id']); ?>&nbsp;</td>
		<td><?php echo h($sensors['sensor']['sensor']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $sensors['Sensor']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $sensors['Sensor']['id'])); ?>
...
<?php endforeach; ?>
	...
	function drawChart() {
		var data = google.visualization.arrayToDataTable([
			...
			<?php foreach ($sensors as $sensor): ?>
			[
				"<?php echo $sensors['sensor']['id']; ?>",
				<?php echo $sensors['sensor']['sensor']; ?>
			],
			<?php endforeach; ?>
		]);
		var options = {
